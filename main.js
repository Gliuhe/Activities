...
function Find()
{
	...
	if (a == "评选文案")
	{
		...
		d.insertAdjacentHTML('beforeend', '<br><a href="https://gliuhe.github.io/Activities/《春游照片评比》文案.docx" font-size: 12px;" download:"https://gliuhe.github.io/Activities/《春游照片评比》文案.docx"><img border="0" src="/word-ico.png" alt="gliuhe.github.io"></a>');
	}
	else if (a == "AP1")
	{
		d.insertAdjacentHTML('beforeend', '<br>');
